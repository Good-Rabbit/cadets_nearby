...
import 'filter_range.dart';
import 'nearby_card.dart';
import 'no_one_nearby.dart';

class PeopleList extends StatefulWidget {
  const PeopleList({Key? key, required this.docs}) : super(key: key);
          ...
          Column(
            children: widget.docs.map(
              (u) {
                ...
                // * Range Check
                if (distanceD > context.read<Nearby>().range.end ||
                    distanceD < context.read<Nearby>().range.start) {
                  dontShow = true;
                }
                // * College Check
